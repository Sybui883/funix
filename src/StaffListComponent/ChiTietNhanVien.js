...
import { Loading } from './Loading';
    ...
    function ChiTietNhanVien({staff, department}) {
        ...
        if (props.isLoading) {
            ...
            return (
                <div className="container">
                    ...
                    <div className="row">
                        <ChiTietNhanVien staff={props.staff}department={props.department.filter(depart => depart.id === props.staff.departmentId)[0]}/>
                    </div>
                </div>
            );
        } else {
